...
class DashboardController extends Controller
{
    ...
    public function index()
    {
    	...
    	$total_number = Blog::with('id')->count();
        return view('dashboard.index', compact('post_number', 'project_number', 'service_number', 'testimonial_number', 'member_number', 'client_number', 'total_number'));
    }
