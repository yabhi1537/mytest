                    ...
                    <tbody>
                        @if($sliders)
                            @foreach($sliders as $key => $slider)
                                <tr><td><input class="checkboxes" type="checkbox" name="checkbox_array[]" value="{{$slider->id}}"></td>
                                    <td><img class="img-fluid pb-4" width="100" height="100" src='{{asset("images/media/".$slider->photo->file)}}'>
