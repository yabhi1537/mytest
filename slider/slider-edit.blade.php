                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                                ...
                                                <textarea name="heading1" id="" class='form-control'  cols="10" rows="10">{{$slider->heading1}}</textarea>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>{{clean( trans('niva-backend.heading_2') , array('Attr.EnableID' => true))}}</strong>
                                                  ...
                                                  <textarea name="heading2" id="" class='form-control'  cols="10" rows="10">{{$slider->heading2}}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <img class="img-fluid pb-4" width="100" height="100" src='{{asset("images/media/".$slider->photo->file)}}'>
