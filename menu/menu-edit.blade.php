                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <div class='row'>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="meta_title" class="form-control" placeholder="meta title" value="{{$menu->meta_title}}">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <strong>Meta Description</strong>
                                            <input type="text" name="meta_description" class="form-control" placeholder="meta description" value="{{$menu->meta_description}}">
                                        </div>
