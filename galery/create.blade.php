...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <a href="{{ route('galery.index') }}" class="btn btn-primary btn-back">{{clean( trans('niva-backend.back_media') , array('Attr.EnableID' => true))}}</a>

            <div class="table-responsive">
			    <form action="{{route('galery.store')}}" class="dropzone" method="POST" enctype="multipart/form-data">
			        @csrf
