                	...
                	<div class="col-md-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-dark">Header Top Section</h6>
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="linkdin" class="form-control" value="{{$setting->linkdin}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-dark">Footer Top Section</h6>
                            </div>
                            <div class="card-body">
                                <form action="{{route('headerfooter-setting.update', $setting->id)}}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row">
                                         <div class="col-md-12">
                                            <div class="form-group">
                                                <strong>Footer Heading</strong>
                                                <input type="text" name="footer_heading" class="form-control" value="{{$setting->footer_heading}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <strong>Office Address</strong>
                                                <input type="text" name="offise_address" class="form-control" value="{{$setting->offise_address}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <strong>Email Us</strong>
                                                <input type="text" name="emailus" class="form-control" value="{{$setting->emailus}}">
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <strong>Contact Us Free</strong>
                                                <input type="text" name="contact_us_free" class="form-control" value="{{$setting->contact_us_free}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                        ...
                        <!--<div class="card shadow mb-4">-->
                        <!--    <div class="card-header py-3">-->
                        <!--        <h6 class="m-0 font-weight-bold text-dark">{{clean( trans('niva-backend.social_links') , array('Attr.EnableID' => true))}}</h6>-->
                        <!--    </div>-->
                        <!--    <div class="card-body">-->
                        <!--        <form action="{{route('headerfooter-setting.update', $setting->id)}}" method="POST" enctype="multipart/form-data">-->
                        <!--            @csrf-->
                        ...
                        <!--            <div class="form-group">-->
                        <!--                <strong>{{clean( trans('niva-backend.description') , array('Attr.EnableID' => true))}}</strong>-->
                        <!--                <textarea name="social_links" class="form-control" rows="6">{{$setting->social_links}}</textarea>-->
                        <!--            </div>-->
                        ...
                        <!--<div class="card shadow mb-4">-->
                        <!--    <div class="card-header py-3">-->
                        <!--        <h6 class="m-0 font-weight-bold text-dark">{{clean( trans('niva-backend.menu_description_sidebar') , array('Attr.EnableID' => true))}}</h6>-->
                        <!--    </div>-->
                        <!--    <div class="card-body">-->
                        <!--        <form action="{{route('headerfooter-setting.update', $setting->id)}}" method="POST" enctype="multipart/form-data">-->
                        <!--            @csrf-->
                        ...
                        <!--            <div class="form-group">-->
                        <!--                <strong>{{clean( trans('niva-backend.description') , array('Attr.EnableID' => true))}}</strong>-->
                        <!--                <textarea name="sidebar_menu_description" class="form-control" rows="6">{{$setting->sidebar_menu_description}}</textarea>-->
                        <!--            </div>-->
