                	...
                	<div class="col-md-12">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-dark"> {{clean( trans('niva-backend.about_settings') , array('Attr.EnableID' => true))}} home page</h6>
                            </div>
                            <div class="card-body">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-dark"> {{clean( trans('niva-backend.about_settings') , array('Attr.EnableID' => true))}} about page</h6>
                            </div>
                            <div class="card-body">
                        		<form action="{{route('about-setting.update', $setting->id)}}" method="POST" enctype="multipart/form-data">
        					        @csrf
                                    ...
                                    <div class="form-group">
                                        <strong>{{clean( trans('niva-backend.description') , array('Attr.EnableID' => true))}}</strong>
                                        <textarea name="description" class="form-control" rows="6">{{clean( $setting->description , array('Attr.EnableID' => true))}}</textarea>
                                    </div>
        					       <div class="col-xs-12 col-sm-12 col-md-12 text-right">
        					           <button type="submit" class="btn btn-primary">{{clean( trans('niva-backend.update') , array('Attr.EnableID' => true))}}</button>
        					        </div>
                            ...
                            <div class="card-body">
                                <form action="{{route('about-setting.update', $setting->id)}}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="member_title_section" class="form-control" rows="6">{{$setting->member_title_section}}</textarea>
                                    </div>
                                    <div class='row'>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>Health Sections</strong>
                                                <input type="text" name="about_subtitle" class="form-control" value="{{$setting->about_subtitle}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>Professionals Doctor</strong>
                                                <input type="text" name="about_title" class="form-control" value="{{$setting->about_title}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <strong>Satisfied Patients</strong>
                                                <input type="text" name="about_buttontext" class="form-control" value="{{$setting->about_buttontext}}">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
